...
<!-- Mirrored from try.htmldemo.net/dgtaka/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Jun 2022 13:03:49 GMT -->
<head>
	<meta charset="utf-8">
...
<body>
	...
	<div id="wrapper" class="wrapper">
		...
		<section class="dg__working__process pb--120 pt--130 bg--white">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
				...
				<div class="row mt--10">
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-12">
						<div class="process">
							<div class="thumb">
								<img src="images/icons/8.png" alt="shape">
							</div>
							<div class="content">
								<h4>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-12">
						<div class="process">
							<div class="thumb">
								<img src="images/icons/9.png" alt="shape">
							</div>
							<div class="content">
								<h4>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-12">
						<div class="process">
							<div class="thumb">
								<img src="images/icons/10.png" alt="shape">
							</div>
							<div class="content">
								<h4>
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-6 col-md-12 col-sm-12 col-12">
						<div class="content">
							...
							<p class="first">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some
								form.</p>
				...
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="dg__software__inner">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
								aliqua. Ut enim ad minim veniam, quis nostrud exercitation Ut enim ad minim veniam, quis nostrud exercitation.</p>
		...
		<!-- Start Blog Area -->
		<section class="dg__blog__area bg--white pb--140 pt--130">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="section__title--2">
					...
					<div class="col-lg-4 col-sm-6 col-12 col-md-6">
						<article class="blog__2">
							...
							<div class="content">
								...
								<p>There are many variations passages of Lorem Ipsum available, the majority have suffered alteration in some form.</p>
							</div>
						</article>
					</div>
					<!-- End Single Blog -->
...
<!-- Mirrored from try.htmldemo.net/dgtaka/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Jun 2022 13:06:49 GMT -->
</html>